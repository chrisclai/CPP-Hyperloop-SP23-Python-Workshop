...
def main():
    ...
    # caption and icon
    pygame.display.set_caption("Welcome to Space Invaders Game by: CPP Hyperloop")
    ...
    # player
    playerImage = pygame.transform.scale(pygame.image.load('assets/img/robotics_transparent.png'), (75,75))
    player_X = 370
    player_Y = 500
    player_Xchange = 0
    ...
    for num in range(no_of_invaders):
        invaderImage.append(pygame.transform.scale(pygame.image.load('assets/img/hyperloop_transparent.png'), (150,100)))
    ...
    global bullet_state
    bulletImage = pygame.transform.scale(pygame.image.load('assets/img/yellow_laser.png'), (50,50))
    bullet_X = 0
    bullet_Y = 500
    bullet_Xchange = 0
    bullet_Ychange = 3
